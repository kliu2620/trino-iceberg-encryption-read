        ...
        extends EnvironmentProvider
{
    ...
    // Match the dep.iceberg.version in the root pom; bump together when upgrading Iceberg.
    private static final String ICEBERG_VERSION = "1.11.0-SNAPSHOT";
    ...
    private DockerContainer createSpark()
    {
        String[] command = ImmutableList.<String>builder()
                ...
                .add("--packages", "org.apache.spark:spark-avro_2.12:3.2.1,org.apache.iceberg:iceberg-aws-bundle:" + ICEBERG_VERSION)
